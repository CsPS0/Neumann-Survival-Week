namespace GameObjectsLib
{
    public class Conversations
    {
        ...
        public static readonly Discussion LeibiTuesday = new Discussion(
            "Leibi",
            Sprites.Leibi,
            "Üdv! Leibinger Bence vagyok a webprogramozás tanár!",
            new Dictionary<char, string> {
        ...
        public static readonly Discussion RizzlerTuesday = new Discussion(
            "Rizzler",
            Sprites.Rizzler,
            "Hallo, ich weiß, das ist etwas zurückhaltend, aber ich schwöre, ich bin kein Schüler, ich bin Lehrer...",
            new Dictionary<char, string>()
        ...
        public static readonly Discussion BarbieTuesday = new Discussion(
            "Barbie",
            Sprites.Barbie,
            "Hi, I'm the English teacher, and many people call me 'Skibidi Barbie' or 'Little Mole'.",
            new Dictionary<char, string> {
        ...
        public static readonly Discussion BranyoTuesday = new Discussion(
            "Branyó",
            Sprites.Branyo,
            "Jajj ne már, a szüleim nem engedtek el gamblingezni, és most elvették az összes pénzem!\nOh, helló, téged még nem ismerlek.",
            new Dictionary<char, string> {
        ...
        public static readonly Discussion CsPSMonday = new Discussion(
            "CsPS",
            Sprites.CsPS,
            "Mi a neved:",
            new Dictionary<char, string>()
        );
        public static readonly Discussion CsPSTuesday = new Discussion(
            "CsPS",
            Sprites.CsPS,
            "Mi a neved:",
            new Dictionary<char, string>()
